<template>   
    <v-container>     
        <v-card>       
            ...
            <h2 class="text-md-center">Data Bengkel Kita</h2>         
...
<v-dialog v-model="dialog" persistent max-width="600px">       
    <v-card>         
        <v-card-title>           
            <span class="headline">Profil Bengkel</span>         
        </v-card-title>         
        <v-card-text>           
            <v-container>             
                <v-row>               
                    ...
                    <v-col cols="12">                 
                        <v-text-field label="numberPhone*" v-model="form.numberPhone" required></v-text-field>               
                    </v-col>
                    <v-col cols="12">                 
            ...
            methods:{         
                getData(){             
                    ...
                    sendData(){             
                        ...
                        this.branches.append('numberPhone', this.form.numberPhone);     
                         this.branches.append('created_at', this.form.created_at);          
                        var uri =this.$apiUrl + '/branches'             
                        this.load = true             
